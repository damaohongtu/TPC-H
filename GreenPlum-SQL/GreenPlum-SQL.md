...
```
source /usr/local/gpdb/greenplum_path.sh
source /home/mao/gpdb/gpAux/gpdemo/gpdemo-env.sh
gpstart #正常启动
gpstop #正常关闭
gpstop -M fast #快速关闭
gpstop –r #重启
...
```
# 建表并加载数据
## <a href="./greenplum_createtables.sql">建表</a>
## <a href="./greenplum_preprocess.sh">数据清洗(去掉.tbl文本最后一个'|'字符)</a>
## <a href="./greenplum_loaddata.sql">加载数据</a>
# 效果
![](../pictures/greenplum_tables.png)
